...
const StateMachine = @import("../engine/state_machine.zig").StateMachine;
const GameStateType = @import("../engine/state_machine.zig").GameStateType;
const StateCallbacks = @import("../engine/state_machine.zig").StateCallbacks;
...
pub const GameState = struct {
    ...
    menu_options: [3][]const u8 = .{ "Start Game", "Credits", "Exit" },
    ...
    pub fn render(self: *GameState) void {
        ...
        // --- Background ---
        rl.drawTexture(self.sprites.get(.bg1), 0, 0, rl.Color.white);
